...
fn emitPrelude(writer: *Io.Writer) Io.Writer.Error!void {
    ...
    try writer.print("%GuestState = type {{ %Registers, i1, i1, i1, i1, i32, [262144 x i8], [32768 x i8], [1024 x i8], [1024 x i8], [98304 x i8], [1024 x i8], i1, i32, i32, %BankedFiqRegisters, [65536 x i8], i32, i32 }}\n", .{});
...
fn emitLoadHelper(writer: *Io.Writer, program: Program) Io.Writer.Error!void {
    ...
    switch (program.save_hardware) {
        ...
        .sram, .flash64 => {
            ...
            try writer.print(
                "  %load32_save_ptr = getelementptr inbounds [65536 x i8], ptr %save_load_ptr, i32 0, i32 %load32_save_offset\n",
                .{},
            );
    ...
    if (program.rom_bytes.len != 0) {
        switch (program.save_hardware) {
            ...
            .sram, .flash64 => {
                ...
                try writer.print(
                    "  %load8_save_ptr = getelementptr inbounds [65536 x i8], ptr %save_load8_ptr, i32 0, i32 %load8_save_offset\n",
                    .{},
                );
    ...
    if (program.rom_bytes.len >= byte_width) {
        switch (program.save_hardware) {
            ...
            .sram, .flash64 => {
                ...
                try writer.print(
                    "  %{s}_save_ptr = getelementptr inbounds [65536 x i8], ptr %save_{s}_ptr, i32 0, i32 %{s}_save_offset\n",
                    .{ load_name, load_name, load_name },
                );
...
fn emitStoreHelper(writer: *Io.Writer, program: Program, bits: u16) Io.Writer.Error!void {
    ...
    switch (program.save_hardware) {
        ...
        .sram => {
            ...
            try writer.print(
                "  %save_store_ptr_{d} = getelementptr inbounds [65536 x i8], ptr %save_ptr_{d}, i32 0, i32 %{s}_save_offset\n",
        ...
        .flash64 => {
            ...
            try writer.print("  br i1 %flash_program_mode_{d}, label %flash_program_write_{d}, label %flash_command_{d}\n", .{
                bits,
                bits,
                bits,
            });
            ...
            try writer.print("  br i1 %flash_program_cmd_{d}, label %flash_enter_program_{d}, label %flash_check_erase_cmd_{d}\n", .{
                bits,
                bits,
                bits,
            });
            ...
            try writer.print("  call void @llvm.memset.p0.i64(ptr align 1 %save_ptr_{d}, i8 -1, i64 65536, i1 false)\n", .{bits});
            try writer.print("  store i32 0, ptr %flash_stage_ptr_{d}, align 4\n", .{bits});
            try writer.print("  store i32 0, ptr %flash_mode_ptr_{d}, align 4\n", .{bits});
            try writer.print("  br label %store_ret_{d}\n", .{bits});
            ...
            try writer.print(
                "  %flash_sector_ptr_{d} = getelementptr inbounds [65536 x i8], ptr %save_ptr_{d}, i32 0, i32 %flash_sector_base_{d}\n",
                .{ bits, bits, bits },
            );
...
fn emitMain(writer: *Io.Writer, program: Program) Io.Writer.Error!void {
    ...
    try writer.print("  call void @llvm.memset.p0.i64(ptr align 1 %state_save_ptr, i8 -1, i64 65536, i1 false)\n", .{});
