...
const guest_state_ewram_field = 5;
const guest_state_iwram_field = 6;
const guest_state_io_field = 7;
const guest_state_palette_field = 8;
const guest_state_vram_field = 9;
const guest_state_oam_field = 10;
const guest_state_dispstat_toggle_field = 11;
const guest_state_mode_field = 12;
const guest_state_spsr_field = 13;
const guest_state_fiq_regs_field = 14;
...
fn emitPrelude(writer: *Io.Writer) Io.Writer.Error!void {
    ...
    try writer.print("%GuestState = type {{ %Registers, i1, i1, i1, i1, [262144 x i8], [32768 x i8], [1024 x i8], [1024 x i8], [98304 x i8], [1024 x i8], i1, i32, i32, %BankedFiqRegisters }}\n", .{});
